...
public class AltaCuenta extends javax.swing.JFrame {
     ...
     */
    public AltaCuenta(Sesion sesion_admin){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AltaCuenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
